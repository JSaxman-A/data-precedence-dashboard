...
const pageContent = {
    livedata: () => `
        <div class="page-header">
            ...
            <p class="page-subtitle">Real-time data from November 2025 • Powered by Looker Studio</p>
        </div>
        
        <div class="looker-embed-container" style="margin-top: 24px; background: #1A1A1A; border-radius: 12px; padding: 16px;">
            <iframe 
                width="100%" 
                height="1400" 
                src="https://lookerstudio.google.com/embed/reporting/9a60a684-3637-4453-8c9b-22985088fd2c/page/mGBmF" 
                frameborder="0" 
        ...
        <div class="info-card" style="margin-top: 24px; padding: 20px; background: rgba(212, 175, 55, 0.1); border: 1px solid rgba(212, 175, 55, 0.3); border-radius: 12px;">
            <h3 style="color: #D4AF37; margin-bottom: 12px;">📊 About This Dashboard</h3>
            <p style="color: #A0A0A0; line-height: 1.6;">
                This is your live data dashboard powered by Google Looker Studio, showing real November 2025 residual data 
                from 507 active merchants. The data includes $52,166.31 in total residuals and $8.16M in processing volume. 
                You can interact with the charts and tables above to explore your portfolio performance.
            </p>
        </div>
    `,
...
document.querySelector('.user-profile-link')?.addEventListener('click', function(e) {
    e.preventDefault();
    document.querySelectorAll('.nav-item').forEach(nav => nav.classList.remove('active'));
